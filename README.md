# Human vs. Robot Rock Paper Scissors Game
...
- Webcam passthrough was inaccessible in WSL2 via usbipd, so I pivoted to a shared file bridge between the Windows inference script and the ROS2 gesture node
